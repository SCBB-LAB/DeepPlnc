...
The user needs to provide the RNA-seq or any other nucleotide sequence data in fasta format. This data is run through the trained bi-modal CNNs which generates a scores for each sequence provided. 
